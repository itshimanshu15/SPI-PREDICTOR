const predict=(e)=>{
    ...
    if(a>36 || a<0 || b<0 || b>36 || c>36 || c<0 || isNaN(a) || isNaN(b) || isNaN(c)){
        output.textContent=("Please Enter The Value Between 0.00 To 36.00");
        output.style.color="red";
        output.style.border="5px double red";
        output.style.borderRadius="25px";
        output.style.padding="22px";
        return; 
    }
    console.log(a,b,c);
    ...
    output.style.border="5px double #7fff00";
    output.style.borderRadius="25px";
    output.style.padding="22px";
}
const query=(a,b,c)=>{
